<div class="banner_list">
    <div class="new_user" data-modal-target="">+ Nuevo</div>

    <!-- Ventana Modal de registro (Si lo quieres probrar) 
...
<div class="grid " id="">
    <div class="title title-usuario">Titulo</div>
    <div class="header">Columna 1</div>
    <div class="header">Columna 2</div>
    <div class="header">Columna 3</div>
    <div class="header">Columna 4</div>
    <div class="header">Columna 5</div>
